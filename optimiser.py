...
class Optimiser:
    ...
    def get_weights(basket_stats, max_beta=1.0, risk_aversion=0.5):
        ...
        current_max_w = 0.35 # Initial concentration cap,but we are always aiming for more than 4 baskets
        ...
        for attempt in range(25):
            ...
            if w.value is not None:
                ...
                return {
                    'weights':       w.value,
                    'max_beta':      current_max_beta,
                    'risk_aversion': current_ra,
                    'max_weight':    current_max_w,
                    'attempts':      attempt + 1,
                }
